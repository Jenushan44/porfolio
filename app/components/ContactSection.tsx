...
function ContactSection() {
  ...
  return (
    ...
    <div className="mx-5 py-12">
      ...
      <div className="mx-auto border-2 border-[#1b88f2] bg-[#001432] max-w-[1300px] flex pb-5">
        <div className="flex w-full">
          <div className="mx-5 mt-5 w-1/3">
            <p className="text-[#1b88f2] font-semibold text-lg">GET IN TOUCH</p>
            <div className="w-[50%] h-[0.5px] bg-[#1b88f2] mb-5" />
            <div className="mb-5">
          ...
          <div className="w-[1px] self-stretch my-2 mt-5 bg-[#1b88f2]" />
              ...
              <div className="w-full">
                <div className="px-5">
                  <div className="w-full flex gap-10 mt-5">
                    <div className="w-1/2">
                      <p>YOUR NAME</p>
                      <input type="text" name="name" required placeholder="John Doe" className="w-full p-2 border-1 border-zinc-800 mt-2" />
                    </div>

                    <div className="w-1/2">
                      <p>YOUR EMAIL</p>
                      <input type="email" name="email" required placeholder="john@example.com" className="w-full p-2 border-1 border-zinc-800 mt-2" />
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full">
                  <div className="px-5">
                    ...
                    <input type="text" name="subject" required placeholder="Quick question" className="w-full p-2 border-1 border-zinc-800 mt-2" />
                  </div>
                </div>
                ...
                <div className="w-full">
                  ...
                  <div className="px-5">
                    <textarea name="message" required placeholder="Hi, I'd like to talk about ..." className="w-full p-2 border border-zinc-800 w-full h-[200px] mt-2 p-1" />
                  </div>
                </div>
