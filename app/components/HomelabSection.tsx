    ...
    <div className="mx-5 py-16">
      <div className="mx-auto w-full max-w-[1400px]">
        ...
        <div className="mt-10 flex gap-5">
          <div className="w-[40%] border-2 border-[#1b88f2] bg-[#001432] p-5 shadow-[8px_8px_0_#0a4f93] transition-all duration-200 hover:-translate-x-[4px] hover:-translate-y-[4px] hover:shadow-[12px_12px_0_#0a4f93]">
            ...
            <div className="mt-8 flex flex-col items-center">
              ...
              <div className="h-8 w-px bg-[#1b88f2]" />
              ...
              <div className="h-8 w-px bg-[#1b88f2]" />
              <div className="h-px w-[70%] bg-[#1b88f2]" />
          ...
          <div className="w-[28%] border-2 border-[#1b88f2] bg-[#001432] p-5 shadow-[8px_8px_0_#0a4f93] transition-all duration-200 hover:-translate-x-[4px] hover:-translate-y-[4px] hover:shadow-[12px_12px_0_#0a4f93]">
          ...
          <div className="w-[32%] border-2 border-[#1b88f2] bg-[#001432] shadow-[8px_8px_0_#0a4f93,inset_0_0_30px_rgba(27,136,242,0.05)] transition-all duration-200 hover:-translate-x-[4px] hover:-translate-y-[4px] hover:shadow-[12px_12px_0_#0a4f93,inset_0_0_30px_rgba(27,136,242,0.05)]">
        ...
        <div className="mt-8 border-2 border-[#1b88f2] bg-[#001432] p-5 shadow-[8px_8px_0_#0a4f93]">
